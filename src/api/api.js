...
export const getAllUsers = (googleId = null) => {
  return ppApi.get(`/users`).then((results) => {
    //console.log(results)
    return results.data;
  });
};
...
export const getUserById = (googleId) => {
  return ppApi.get(`/users/${googleId}`).then((results) => {
    //console.log(results)
    return results.data;
  });
};
...
export const deleteUserById = (googleId) => {
  return ppApi.delete(`/users/${googleId}`).then((results) => {
    //console.log(results)
...
export const addNewUser = (data) => {
  // data object,
  return ppApi.post("/signup").then((results) => {
    //console.log(results)
...
export const createLinkToken = (data) => {
  // data object,
  return ppApi.post("/create_link_token", {}).then((results) => {
    //console.log(results)
...
export const tokenExchange = (data) => {
  // data object,
  return ppApi.post("/exchange_public_token", data).then((results) => {
    //console.log(results)
    return results.data; // returned token object
  });
};
...
export const authUser = (data) => {
  // data object,
  console.log(data);
  return ppApi.post("/auth", data).then((results) => {
    console.log(results);
    return results.data; // returned token object
  });
};
...
export const getTransactions = (data, sort_by, order) => {
  // data googleId,
  return ppApi
    .post(
      `/plaid/transactions?sort_by=${sort_by}&order=${order}`,
...
export const getTransactionNotes = (data) => {
  // data object,
  return ppApi.post("/api/notes/:transaction_id").then((results) => {
    //console.log(results)
    return results.data; // returned token object
  });
};
